...
from omni.plotter import *

#---update for new omnicalc
from omni.plotter.panels import panelplot
...
def plothull(ax,points,griddims=None,vecs=None,c=None,mset=None,
	...
	for pts in points:
		...
		#! some of the incoming data for dextran does not have more than one point because it is just a sphere
		except:
			p = ax.add_patch(mpl.patches.Circle(pts[0]))
		patches.append(p)
	return patches
