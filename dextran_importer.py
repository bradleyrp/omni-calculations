...
def repacker(source,source_out):
	...
	for frameno in framenos:
		...
		#! WHY WAS THIS HERE? if not np.all(regular!=0.0): raise Exception('some points are zero!')
		mesh.append(regular)
...
post_dn = "/home/rpb/omicron/dataset-project-polymers/samrad-curvature-2019.03.00/ResultsForDex/CL160ENS-1"
sources = {
	'CL160ENS-1':
